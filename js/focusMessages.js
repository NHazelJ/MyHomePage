...
export const focusMessages = [
  ...
  "Learning how Bootstrap helps make pages responsive",
  "Building my GitHub portfolio one project at a time",
  "Connecting my data analytics experience with software development",
  "Playing futbol and getting ready for the World Cup!"
];
